...
public:
  ...
  // TODO(rhett): is the output fragment pool packet length supposed to match a
  // data header?
  //              We could probably even replace this with just a flat buffer
  //              eventually,
  //							solving this little
  // issue
